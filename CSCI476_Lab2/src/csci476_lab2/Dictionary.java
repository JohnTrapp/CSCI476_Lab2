...
public class Dictionary {
    ...
    public boolean importDictionary() { //Imports and compresses the dictionary
        //@todo

        //Uses the hashList to compress the dictionary to usefull results.
        //return true if successful
        return false; //dictionary import and compression failed
    }
